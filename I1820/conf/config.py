    ...
    settings = LazySettings(
        ...
        validators=[
            Validator('database.name', is_type_of=(str),
                      is_in=("mongodb", "influxdb"), default="mongodb"),
            Validator('database.config.host', is_type_of=(str),
                      default="mongodb://127.0.0.1"),
            Validator('database.config.port', is_type_of=(int),
                      default=27017),
            Validator('database.config.database', is_type_of=(str),
                      default="mia"),
